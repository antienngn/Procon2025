...
"""
Task 1: Verify dynamic block for columns again
Task 2: Process when cell can move directly to target
Task 3: Solution for special case (when anti clockwise few step)
"""
